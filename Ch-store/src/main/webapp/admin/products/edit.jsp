				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>ID Sản phẩm</label> <input value="${products.ID}" readonly
							name="id" type="text" class="form-control mb-3" /> <span
							class="alert-danger"></span>
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>Tên sản phẩm</label> <input value="${products.title}"
							name="name" type="text" class="form-control mb-3"
							placeholder="Nhập tên sản phẩm" /> <span class="alert-danger"></span>
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
