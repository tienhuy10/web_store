          ...
          <li class="nav-item dropdown">
            ...
            >
              ...
              <li class="message-item">
                <a href="#">
                  <img
                    src="admin/assets/img/messages-1.jpg"
                    alt=""
              ...
              <li class="message-item">
                <a href="#">
                  <img
                    src="admin/assets/img/messages-2.jpg"
                    alt=""
                    class="rounded-circle"
                  />
                  <div>
              ...
              <li class="message-item">
                <a href="#">
                  <img
                    src="admin/assets/img/messages-3.jpg"
                    alt=""
                    class="rounded-circle"
                  />
                  <div>
                    ...
                    <table class="table table-borderless">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img src="admin/assets/img/product-2.jpg" alt=""
                            /></a>
                          </th>
                          <td>
                            <a href="#" class="text-primary fw-bold"
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img src="admin/assets/img/product-3.jpg" alt=""
                            /></a>
                          </th>
                          <td>
                            <a href="#" class="text-primary fw-bold"
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img src="admin/assets/img/product-4.jpg" alt=""
                            /></a>
                          </th>
                          <td>
                            <a href="#" class="text-primary fw-bold"
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img src="admin/assets/img/product-5.jpg" alt=""
                            /></a>
                          </th>
                          <td>
                            <a href="#" class="text-primary fw-bold"
